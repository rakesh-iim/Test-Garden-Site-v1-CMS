...
export const siteTree: TreeNode[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: '/dashboard/global/floating-contact',
        pageId: 'floating_contact',
        title: 'Floating Contact Actions',
        description: 'Manage the fixed WhatsApp and phone actions shown across the public website.',
        icon: MapPinned,
        fields: pageFieldSets.floating_contact,
      },
    ],
  },
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            id: 'homepage-process',
            label: 'How It Works',
            path: '/dashboard/pages/homepage/how-it-works',
            pageId: 'homepage_process',
            title: 'Homepage How It Works',
            description: 'Edit the process steps and CTA shown in the How It Works section.',
            icon: PanelsTopLeft,
            fields: pageFieldSets.homepage_process,
          },
          {
            type: 'editor',
            id: 'homepage-clients',
            label: 'Client Marquee',
            path: '/dashboard/pages/homepage/client-marquee',
            pageId: 'homepage_clients',
            title: 'Homepage Client Marquee',
            description: 'Manage the marquee heading and client names shown on the homepage.',
            icon: LayoutTemplate,
            fields: pageFieldSets.homepage_clients,
          },
        ],
      },
      {
      ...
      },
      {
        ...
        path: '/dashboard/pages/services/testimonials',
        pageId: 'service_testimonials',
        title: 'Service Testimonials',
        description: 'Manage the shared testimonial slider used on service-focused sections.',
        icon: NotebookPen,
        fields: pageFieldSets.service_testimonials,
      },
      {
        type: 'editor',
        id: 'gallery',
